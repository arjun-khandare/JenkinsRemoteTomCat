...
public class GetDao
{
	public Users getUser(int emp_no)
	{
		...
		try
		{
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://java-tomcat-db-1.c1gvo6axtmuz.us-east-1.rds.amazonaws.com:3306/db","admin","AWSDevOps#123");
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://java-tomcat-db-1.c1gvo6axtmuz.us-east-1.rds.amazonaws.com:3306/db",db_username,db_password);
			*/
